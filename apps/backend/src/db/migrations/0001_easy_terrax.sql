...
--> statement-breakpoint
ALTER TABLE "mentions" DROP CONSTRAINT "mentions_user_id_user_id_fk";
--> statement-breakpoint
ALTER TABLE "notifications" DROP CONSTRAINT "notifications_user_id_user_id_fk";
--> statement-breakpoint
ALTER TABLE "time_entries" DROP CONSTRAINT "time_entries_user_id_user_id_fk";
--> statement-breakpoint
ALTER TABLE "tasks" ALTER COLUMN "organization_id" DROP NOT NULL;--> statement-breakpoint
